...
load("/Volumes/Groupdir/SUN-ODONT-PHD_projekt_Caroline/DATA_ADM/Trial2_analysis/07_metaphlan/R/07_metaphlan_to_phyloseq/01_data.Rdata")
...
load("/Volumes/Groupdir/SUN-ODONT-PHD_projekt_Caroline/DATA_ADM/Trial2_analysis/08_humann/R/01_humann_data.Rdata")
...
```{r select alpha diversity measures for taxonomy}
...
alpha_long_df <- alphas %>% 
  ...
  mutate(
    alphadiversiy = fct_relevel(alphadiversiy, alpha_measures)
  )
...
```{r select alpha diversity measures for pathways}
# Select alpha diversity measures of interest 
alpha_measures <- c("diversity_shannon") 
# Other available measures:
# "observed", "diversity_coverage", "diversity_inverse_simpson", "evenness_pielou"
