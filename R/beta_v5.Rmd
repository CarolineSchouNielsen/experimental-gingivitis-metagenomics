...
load(here::here("/Users/lnp524/Desktop/01_data.Rdata"))
...
load(here::here("/Users/lnp524/Desktop/01_humann_data.Rdata"))
...
```{r}
tax_saliva_tp12$PCOA$p + labs(title = "", x = "Axis 1 [62.7%]", y = "Axis 2 [25.1%]") -> tax_saliva_tp12_PCOA

tax_saliva_tp12_PCOA
```
...
```{r}
tax_saliva_tp23$PCOA$p + labs(title = "", x = "Axis 1 [54.4%]", y = "Axis 2 [30%]") -> tax_saliva_tp23_PCOA

tax_saliva_tp23_PCOA
```
...
```{r}
tax_saliva_tp13$PCOA$p + labs(title = "", x = "Axis 1 [56.9%]", y = "Axis 2 [26.1%]") -> tax_saliva_tp13_PCOA

tax_saliva_tp13_PCOA
```
...
```{r}
tax_plaque_tp12$PCOA$p + labs(title = "", x = "Axis 1 [58.3%]", y = "Axis 2 [22.1%]") -> tax_plaque_tp12_PCOA

tax_plaque_tp12_PCOA
```
...
```{r}
tax_plaque_tp23$PCOA$p + labs(title = "", x = "Axis 1 [56.2%]", y = "Axis 2 [27.7%]") -> tax_plaque_tp23_PCOA

tax_plaque_tp23_PCOA
```
...
```{r}
tax_plaque_tp13$PCOA$p + labs(title = "", x = "Axis 1 [49%]", y = "Axis 2 [33.8%]") -> tax_plaque_tp13_PCOA

tax_plaque_tp13_PCOA
```
...
```{r}
pway_saliva_tp12$PCOA$p + labs(title = "", x = "Axis 1 [61.3%]", y = "Axis 2 [31.9%]") -> pway_saliva_tp12_PCOA

pway_saliva_tp12_PCOA
```
...
```{r}
pway_saliva_tp23$PCOA$p + labs(title = "", x = "Axis 1 [72.5%]", y = "Axis 2 [23.3%]") -> pway_saliva_tp23_PCOA

pway_saliva_tp23_PCOA
```
...
```{r}
pway_saliva_tp13$PCOA$p + labs(title = "", x = "Axis 1 [72.6%]", y = "Axis 2 [20.4%]") -> pway_saliva_tp13_PCOA

pway_saliva_tp13_PCOA
```
...
```{r}
pway_plaque_tp12$PCOA$p + labs(title = "", x = "Axis 1 [70.4%]", y = "Axis 2 [21.3%]") -> pway_plaque_tp12_PCOA

pway_plaque_tp12_PCOA
```
...
```{r}
pway_plaque_tp23$PCOA$p + labs(title = "", x = "Axis 1 [58.3%]", y = "Axis 2 [30.7%]") -> pway_plaque_tp23_PCOA 

pway_plaque_tp23_PCOA
```
...
```{r}
pway_plaque_tp13$PCOA$p + labs(title = "", x = "Axis 1 [67.6%]", y = "Axis 2 [22.7%]") -> pway_plaque_tp13_PCOA

pway_plaque_tp13_PCOA
```
...
```{r joined figures saliva - baseline vs week 2}
tax_saliva_tp12_PCOA + pway_saliva_tp12_PCOA

ggsave("/Users/lnp524/Desktop/saliva_baseline_week2.png", width = 30, height = 30, units = c("cm"), dpi = 300)
```

```{r joined figures saliva - week 2 vs week 4}
tax_saliva_tp23_PCOA + pway_saliva_tp23_PCOA

ggsave("/Users/lnp524/Desktop/saliva_week2_week4.png", width = 30, height = 30, units = c("cm"), dpi = 300)
```

```{r joined figures saliva - baseline vs week 4}
tax_saliva_tp13_PCOA + pway_saliva_tp13_PCOA

ggsave("/Users/lnp524/Desktop/saliva_baseline_week4.png", width = 30, height = 30, units = c("cm"), dpi = 300)
```

```{r joined figures plaque - baseline vs week 2}
tax_plaque_tp12_PCOA + pway_plaque_tp12_PCOA

ggsave("/Users/lnp524/Desktop/plaque_baseline_week2.png", width = 30, height = 30, units = c("cm"), dpi = 300)
```

```{r joined figures plaque - week 2 vs week 4}
tax_plaque_tp23_PCOA + pway_plaque_tp23_PCOA

ggsave("/Users/lnp524/Desktop/plaque_week2_week4.png", width = 30, height = 30, units = c("cm"), dpi = 300)
```

```{r joined figures plaque - baseline vs week 4}
tax_plaque_tp13_PCOA + pway_plaque_tp13_PCOA

ggsave("/Users/lnp524/Desktop/plaque_baseline_week4.png", width = 30, height = 30, units = c("cm"), dpi = 300)
```

```{r legend baseline vs week 2}
tax_saliva_tp12$PCOA$p_leg
ggsave("/Users/lnp524/Desktop/legend_baseline_week2.png", width = 10, height = 10, units = c("cm"), dpi = 300)
```

```{r legend week 2 vs week 4}
tax_saliva_tp23$PCOA$p_leg
ggsave("/Users/lnp524/Desktop/legend_week2_week4.png", width = 10, height = 10, units = c("cm"), dpi = 300)
```

```{r legend baseline vs week 4}
tax_saliva_tp13$PCOA$p_leg
ggsave("/Users/lnp524/Desktop/legend_baseline_week4.png", width = 10, height = 10, units = c("cm"), dpi = 300)
```
